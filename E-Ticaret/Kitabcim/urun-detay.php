							...
							while($urunaltcek=$urunaltsor->fetch(PDO::FETCH_ASSOC)) {
								...
								<div class="col-md-4">
									<div class="productwrap">
										<div class="pr-img">
											<a href="urun-<?=seo($urunaltcek["urun_ad"]).'-'.$urunaltcek["urun_id"]?>"><img src="" alt="" class="img-responsive"></a>
										...
										<span class="smalltitle"><a href="#"><?php echo $urunaltcek['urun_ad'] ?></a></span>
