...
<head>
  ...
  <title>Kitapcim</title>
  
<link rel="shortcut icon" type="image/jpg" href="../../dimg/ikon.jpg"/>
  <!-- Bootstrap -->
        ...
        <div class="left_col scroll-view">
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="../../dimg/kullanici/<?php echo $kullanicicek['kullanici_resim']?>" alt="..." class="img-circle profile_img">
            </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="">
            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              <img src="../../dimg/kullanici/<?php echo $kullanicicek['kullanici_resim']?>" alt="><?php echo $kullanicicek['kullanici_adsoyad'] ?>
